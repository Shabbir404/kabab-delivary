...
const Contact = () => {
    ...
    return (
        <div>
            <div className='overleyImg-contact h-96 '>
                <nav className="w-full md:w-10/12  md:mx-auto md:mt-0 mt-5">
                    <div className="  px-4">
                        <div className="flex justify-between items-center h-16">
                            ...
                            <div className="hidden md:flex items-center mx-auto text-xl space-x-8 menu-font">
                                <Link to="/" className="text-white hover:text-blue-600 transition duration-300">Start</Link>
                            ...
                            <div className='flex'>
                                <MdOutlineShoppingBag className='md:block text-white text-4xl md:mr-4 md:mt-2 mt-0 md:ml-0 ml-72' ></MdOutlineShoppingBag>
                    ...
                    {isOpen && (
                        <div className="md:hidden mt-10 rounded-md text-center">
                            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white">
                                <Link to="/" className="block px-3 py-2 text-gray-700 hover:text-blue-600 transition duration-300">Start</Link>
                ...
                <h1 className='text-6xl text-center mt-32 permanent-marker-regular-font
                 text-white '>Contact</h1>
            </div>
            <div>
